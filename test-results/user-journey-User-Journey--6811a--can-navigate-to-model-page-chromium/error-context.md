...
- Name: user-journey.spec.ts >> User Journey >> Scenario Modeling Flow >> can navigate to model page
- Location: tests/e2e-browser/user-journey.spec.ts:242:5
...
Received string:  "https://many-sunbird-48.accounts.dev/sign-in?redirect_url=http%3A%2F%2Flocalhost%3A4321%2Fmodel"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    2 × unexpected value "https://many-sunbird-48.accounts.dev/sign-in?redirect_url=http%3A%2F%2Flocalhost%3A4321%2Fmodel&__clerk_db_jwt=dvb_3DNOVbPMduiwuxmnc78ogYQjJFY"
    7 × unexpected value "https://many-sunbird-48.accounts.dev/sign-in?redirect_url=http%3A%2F%2Flocalhost%3A4321%2Fmodel"
    ...
    - generic [ref=e43]:
      - generic [ref=e44]:
        ...
        - link "Sign up" [ref=e46] [cursor=pointer]:
          - /url: https://many-sunbird-48.accounts.dev/sign-up#/?redirect_url=http%3A%2F%2Flocalhost%3A4321%2Fmodel
      - generic [ref=e48]:
        - generic [ref=e50]:
