...
- Name: user-journey.spec.ts >> User Journey >> Sales Flow >> import button is visible
- Location: tests/e2e-browser/user-journey.spec.ts:199:5
...
Locator: locator('.import-fab, button:has-text("Import")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.import-fab, button:has-text("Import")')
