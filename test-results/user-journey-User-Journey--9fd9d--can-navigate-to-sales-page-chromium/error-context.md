...
- Name: user-journey.spec.ts >> User Journey >> Sales Flow >> can navigate to sales page
- Location: tests/e2e-browser/user-journey.spec.ts:180:5
...
Received string:  "https://many-sunbird-48.accounts.dev/sign-in?redirect_url=http%3A%2F%2Flocalhost%3A4321%2Fsales"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    3 × unexpected value "https://many-sunbird-48.accounts.dev/sign-in?redirect_url=http%3A%2F%2Flocalhost%3A4321%2Fsales&__clerk_db_jwt=dvb_3DNOUbTstqhsJglVKWJJPz2WoPw"
    6 × unexpected value "https://many-sunbird-48.accounts.dev/sign-in?redirect_url=http%3A%2F%2Flocalhost%3A4321%2Fsales"
    ...
    - generic [ref=e43]:
      - generic [ref=e44]:
        ...
        - link "Sign up" [ref=e46] [cursor=pointer]:
          - /url: https://many-sunbird-48.accounts.dev/sign-up#/?redirect_url=http%3A%2F%2Flocalhost%3A4321%2Fsales
      - generic [ref=e48]:
        - generic [ref=e50]:
