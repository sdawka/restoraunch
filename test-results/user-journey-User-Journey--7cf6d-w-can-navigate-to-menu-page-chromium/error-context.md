...
- Name: user-journey.spec.ts >> User Journey >> Menu Flow >> can navigate to menu page
- Location: tests/e2e-browser/user-journey.spec.ts:136:5
...
Expected pattern: /\/menu/
Received string:  "https://many-sunbird-48.accounts.dev/sign-in?redirect_url=http%3A%2F%2Flocalhost%3A4321%2Fmenu"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    3 × unexpected value "https://many-sunbird-48.accounts.dev/sign-in?redirect_url=http%3A%2F%2Flocalhost%3A4321%2Fmenu&__clerk_db_jwt=dvb_3DNOURvhqdM6d3kbin8qJi0g65v"
    6 × unexpected value "https://many-sunbird-48.accounts.dev/sign-in?redirect_url=http%3A%2F%2Flocalhost%3A4321%2Fmenu"
    ...
    - generic [ref=e43]:
      - generic [ref=e44]:
        ...
        - link "Sign up" [ref=e46] [cursor=pointer]:
          - /url: https://many-sunbird-48.accounts.dev/sign-up#/?redirect_url=http%3A%2F%2Flocalhost%3A4321%2Fmenu
      - generic [ref=e48]:
        - generic [ref=e50]:
