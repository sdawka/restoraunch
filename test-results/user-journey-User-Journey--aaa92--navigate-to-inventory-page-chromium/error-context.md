...
- Name: user-journey.spec.ts >> User Journey >> Inventory Flow >> can navigate to inventory page
- Location: tests/e2e-browser/user-journey.spec.ts:87:5
...
Received string:  "https://many-sunbird-48.accounts.dev/sign-in?redirect_url=http%3A%2F%2Flocalhost%3A4321%2Finventory"
Timeout: 5000ms

Call log:
  - Expect "toHaveURL" with timeout 5000ms
    3 × unexpected value "https://many-sunbird-48.accounts.dev/sign-in?redirect_url=http%3A%2F%2Flocalhost%3A4321%2Finventory&__clerk_db_jwt=dvb_3DNOTZBLrM5gcrvDOhDxEgEKdkE"
    6 × unexpected value "https://many-sunbird-48.accounts.dev/sign-in?redirect_url=http%3A%2F%2Flocalhost%3A4321%2Finventory"
