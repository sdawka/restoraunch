...
- Name: user-journey.spec.ts >> User Journey >> Sales Flow >> sales page loads
- Location: tests/e2e-browser/user-journey.spec.ts:190:5
...
Locator: locator('h1:has-text("Sales")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h1:has-text("Sales")')
