...
- Name: user-journey.spec.ts >> User Journey >> Inventory Flow >> receipt scanner section is visible
- Location: tests/e2e-browser/user-journey.spec.ts:107:5
...
Locator: locator('h2:has-text("Receipt Scanner")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h2:has-text("Receipt Scanner")')
